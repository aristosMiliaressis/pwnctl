...
// var queueNotEmptyAlarm = new Alarm(this, "pwnwrk-queue-not-empty", new AlarmProps
// {
//     Metric = new MathExpression(new MathExpressionProps
//     {
//         Expression = "ApproximateNumberOfMessagesVisible >= 1",
//         UsingMetrics = new Dictionary<string, IMetric> {
//             { "ApproximateNumberOfMessagesVisible", queueDepthMetric }
//         },
//         Period = Duration.Seconds(60)
//     }),
//     EvaluationPeriods = 1,
...
// var queueMoreThan80Alarm = new Alarm(this, "pwnwrk-queue-more-than-80", new AlarmProps
// {
//     Metric = new MathExpression(new MathExpressionProps
//     {
//         Expression = "ApproximateNumberOfMessagesVisible >= 80",
//         UsingMetrics = new Dictionary<string, IMetric> {
//             { "ApproximateNumberOfMessagesVisible", queueDepthMetric }
//         },
//         Period = Duration.Seconds(60)
...
// var queueEmptyAlarm = new Alarm(this, "pwnwrk-queue-empty", new AlarmProps
// {
//     Metric = new MathExpression(new MathExpressionProps
//     {
//         Expression = "ApproximateNumberOfMessagesVisible <= 0",
//         UsingMetrics = new Dictionary<string, IMetric> {
//             { "ApproximateNumberOfMessagesVisible", queueDepthMetric }
//         },
//         Period = Duration.Seconds(60)
...
// var queueLessThan80Alarm = new Alarm(this, "pwnwrk-queue-less-than-80", new AlarmProps
// {
//     Metric = new MathExpression(new MathExpressionProps
//     {
//         Expression = "ApproximateNumberOfMessagesVisible <= 80",
