...
namespace pwnctl.infra.Persistence.Migrations
{
    ...
    [Migration("20220827153248_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pwnctl.core.Entities.Assets.Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("pwnctl.core.Entities.Assets.Response", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("pwnctl.core.Entities.Assets.Parameter", b =>
                {
                    ...
                    b.HasOne("pwnctl.core.Entities.Assets.Request", "Request")
                        .WithMany()
                        .HasForeignKey("RequestId");

                    b.HasOne("pwnctl.core.Entities.Assets.Request", null)
                        .WithMany("Parameters")
            ...
            modelBuilder.Entity("pwnctl.core.Entities.Assets.Request", b =>
                {
                    ...
                    b.HasOne("pwnctl.core.Entities.Assets.Response", "Response")
                        .WithMany()
            ...
            modelBuilder.Entity("pwnctl.core.Entities.Tag", b =>
                {
                    ...
                    b.HasOne("pwnctl.core.Entities.Assets.Response", null)
                        .WithMany("Tags")
