...
namespace pwnwrk.infra.cdk.Stacks
{
    internal class PwnctlStack : Stack
    {
        internal PwnctlStack(Construct scope, string id, IStackProps props = null) : base(scope, id, props)
        {
            ...
            #region Aurora RDS
            var dbCredSecret = new SecretsManager.Secret(this, AwsConstants.DatabaseCredSecret, new SecretProps
            {
            ...
            #region Lambda API
            var apiKeySecret = new SecretsManager.Secret(this, AwsConstants.ApiKeyId, new SecretProps
            {
