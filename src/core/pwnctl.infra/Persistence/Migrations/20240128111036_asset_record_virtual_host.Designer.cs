...
namespace pwnctl.infra.Migrations
{
    ...
    [Migration("20240128111036_asset_record_virtual_host")]
    partial class asset_record_virtual_host
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pwnctl.app.Assets.Entities.AssetRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("pwnctl.app.Operations.Entities.PolicyTaskProfile", b =>
                {
                    b.Property<int>("PolicyId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("PolicyId", "TaskProfileId");

                    b.HasIndex("TaskProfileId");

                    b.ToTable("policy_task_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("pwnctl.app.Tasks.Entities.TaskDefinition", b =>
                {
                    ...
                    b.Property<bool>("CheckNotificationRules")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("ShortLived")
                        .HasColumnType("boolean");

                    b.Property<string>("StdinQuery")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("pwnctl.domain.Entities.HttpEndpoint", b =>
                {
                    ...
                    b.Property<Guid?>("BaseEndpointId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("pwnctl.domain.Entities.VirtualHost", b =>
                {
                    ...
                    b.HasIndex("SocketAddress", "Hostname")
                        .IsUnique();
            ...
            modelBuilder.Entity("pwnctl.app.Notifications.Entities.Notification", b =>
                {
                    b.HasOne("pwnctl.app.Assets.Entities.AssetRecord", "Record")
            ...
            modelBuilder.Entity("pwnctl.domain.Entities.HttpEndpoint", b =>
                {
                    b.HasOne("pwnctl.domain.Entities.HttpEndpoint", "BaseEndpoint")
                        .WithMany()
                        .HasForeignKey("BaseEndpointId");
            ...
            modelBuilder.Entity("pwnctl.domain.Entities.VirtualHost", b =>
                {
                    b.HasOne("pwnctl.domain.Entities.DomainName", "Domain")
                        .WithMany()
                        .HasForeignKey("DomainId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
